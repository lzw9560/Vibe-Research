...
class TestComputeStrategyScore:
    ...
    def test_storm_reversal_uses_seal_and_freq(self, monkeypatch):
        ...
        # seal 90×0.6=54, (100-20)×0.4=32, total=86; S161 R8 gene-based ×0.5 (days=38<60 provisional): seal 27.0 + freq 16.0 = 43.0
        assert score == 43.0
        assert breakdown["factor_seal_rate"] == 27.0
    ...
    def test_reverse_factor_uses_100_minus_value(self, monkeypatch):
        ...
        # freq 反向：100-20=80, 80×0.4=32, S161 R8 gene-based ×0.5 (days=38<60 provisional) = 16.0
        assert breakdown["factor_freq_score"] == 16.0

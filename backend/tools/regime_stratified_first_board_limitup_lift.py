#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""First-board limitup x MA20 3-way regime stratified S44 harness.

Question: is first-board limitup overnight return a regime artifact?
...
SCRIPT_PATH: str = "tools/regime_stratified_first_board_limitup_lift.py"

STRATEGY_NAME: str = "first_board_limitup"
...
def run(
    *,
    ...
    """Run per-regime S44v2 event verdict for first-board limitup.
...
def main() -> int:
    """Real-data entry point (requires first-board picks + regime cache).

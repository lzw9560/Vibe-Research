...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/sentiment/weather", element: <Navigate to="/workflow/intraday" replace /> },
      { path: "/sentiment/weather/history", element: <Navigate to="/workflow/intraday" replace /> },
      { path: "/sentiment/weather/strategy", element: <Navigate to="/workflow/intraday" replace /> },
      { path: "/sentiment/weather/fuse", element: <Navigate to="/workflow/intraday" replace /> },

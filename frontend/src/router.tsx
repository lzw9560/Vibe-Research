...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/sentiment/weather", element: lazyEl(() => import("@/pages/sentiment/SentimentWeather"), "SentimentWeather") },
      { path: "/sentiment/weather/history", element: lazyEl(() => import("@/pages/sentiment/SentimentWeather"), "SentimentWeather") },
      { path: "/sentiment/weather/strategy", element: lazyEl(() => import("@/pages/sentiment/SentimentWeather"), "SentimentWeather") },
      { path: "/sentiment/weather/fuse", element: lazyEl(() => import("@/pages/sentiment/SentimentWeather"), "SentimentWeather") },

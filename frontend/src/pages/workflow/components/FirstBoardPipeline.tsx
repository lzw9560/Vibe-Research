...
import type {
  FirstBoardCandidatesResponse, FirstBoardExcludedItem,
} from "@/lib/api";
import { NODE, ArrowDown, FunnelShrinkBar } from "@/components/pipeline/primitives";
// S179 R3.4: 拆分——节点样式 + 评分表抽出独立模块（本文件 1126→~727 行 <800 合规）
import { NODE_DASHED, NODE_GREEN, NODE_AMBER, NODE_RED } from "./first-board-pipeline/styles";
import { CandidateScoreTable } from "./first-board-pipeline/CandidateScoreTable";

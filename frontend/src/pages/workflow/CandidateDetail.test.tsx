...
// S033 R6：Panel 底部嵌 WorkflowStateCard（react-query），测试需 QueryClientProvider。
...
describe("CandidateDetailPanel", () => {
  ...
  it("加载中显示 Skeleton", () => {
    ...
    const { container } = renderWithClient(<CandidateDetailPanel code="000001" />);
  ...
  it("取数成功渲染诊断卡名称 + 命中规则", async () => {
    ...
    renderWithClient(<CandidateDetailPanel code="000001" />);

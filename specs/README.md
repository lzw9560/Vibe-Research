...
| [S066](S066-策略特定漏斗架构重构/spec.md) | 策略特定漏斗架构重构 | 🟡Phase 0-2 完成 2026-08-14 | spec · [plan](S066-策略特定漏斗架构重构/plan.md) · [tasks](S066-策略特定漏斗架构重构/tasks.md) · [HANDOFF-PROMPT](S066-策略特定漏斗架构重构/HANDOFF-PROMPT.md) | 3 套权重漏斗 + 天气硬开关 + 板块周期 + 日历因子 + 前端三页统一（后端 9 模块 201 测试 + 5 API） |

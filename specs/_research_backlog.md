...
| S201 | CRITICAL bug 修复 | cost 口径统一(accounting 0.70% spread 0.60%美股假设 vs S194 0.2% A股真实不含spread,§44 net verdict -1.14% vs +0.36% 不可复现)+gap 前视修复(_is_filled D+1..D+3 前视膨胀 R5 v3) | ⏳ spec 草案落（6 视角对抗审修复方案） | 撞判断须可复现底线;R1 cost 统一+R2 gap 训练/实盘分模式+R3 对抗审;影响 1092case/forward_test/S194 F3/S192 + chat.TOOLS/fusion/R4/R5 |

...
> 状态：已实现（2026-09-05）——R1-R5 后端（05d4f15）+ R3 scheduled evaluation_backtest + test_s151（21 测）+ 前端 S8-S13（ee58a02）全绿；§F breakout ×0.5 按梯度落地（可改 note='override' 翻 ×0.1）；补数据等 S150 采集 30 天
